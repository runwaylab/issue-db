...
describe GitHubApp do
  ...
  describe "#initialize" do
    ...
    it "initializes with provided parameters" do
      ...
      github_app = GitHubApp.new(log: custom_logger, app_id: 999, installation_id: 888,
    ...
    it "loads app key from .pem file path" do
      ...
      github_app = GitHubApp.new(app_id: 999, installation_id: 888, app_key: pem_file_path)
    ...
    context "error handling" do
      it "raises error when app key file doesn't exist" do
        expect {
          GitHubApp.new(app_id: 999, installation_id: 888, app_key: "nonexistent_file.pem")
      ...
      it "raises error when app key file is empty" do
        ...
        begin
          expect {
            GitHubApp.new(app_id: 999, installation_id: 888, app_key: empty_file_path)
    ...
    it "processes escape sequences in app key string" do
      ...
      github_app = GitHubApp.new(app_id: 999, installation_id: 888, app_key: key_with_escapes)
  ...
  describe "#method_missing" do
    ...
    context "retry behavior" do
      ...
      it "retries with fixed rate (default behavior)" do
        ...
        expect(github_app).to have_received(:sleep).twice
      end
      ...
      it "retries with exponential backoff when enabled" do
        ...
        allow(github_app_exponential).to receive(:sleep)

        result = github_app_exponential.organizations
        expect(result).to eq("orgs_data")
        expect(github_app_exponential).to have_received(:sleep).twice
      end
